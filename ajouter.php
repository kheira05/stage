                ...
                <div class="card-body">
                    <form method="POST">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                           <input type="hidden"  name="id" class="form-control" value ="<?php echo $id;?> "placeholder="Tapez le nom"/>
                                            <input type="text"  name="nom"value ="<?php echo $nom;?>" class="input--style-5" placeholder="Tapez le nom" required=""/>
                                    ...
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            ...
                                            <input type="text"  name="prenom" value ="<?php echo $prenom;?>" class="input--style-5"  required=""/>
                       ...
                       <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="implantation" required="">
                                           <?php
                                             include_once("config.php");
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-5" type="mail" name="mail" value ="<?php echo $mail;?>" class="form-control" required="">
                                </div>
                            </div>
                        </div>
                        <div class="form-row m-b-55">
                         ...
                         <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-5" type="text" name="inventaire_fixe" value ="<?php echo $inventaire_fixe;?>" class="form-control" required="">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-5" type="text" name="inventaire_affecte" value ="<?php echo $inventaire_affecte;?>" class="form-control" required="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-5" type="text" name="poste_affecte" value ="<?php echo $poste_affecte;?>" class="form-control" required="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" type="submit" name="btn_Ajout" value="Enregistrer">Enregistrer</button>
                            <a href="home.php" id="cancel" name="cancel" class="btn btn--radius-2 btn--red">Annuler</a>
